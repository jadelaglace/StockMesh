...
Observed engineering terminal: one shared capability facade, dependency-free CLI, and
...
PR #11 squash-merged as `8ab1b40`. Human product acceptance remains separate.
