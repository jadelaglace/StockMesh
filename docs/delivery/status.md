...
| Candidate Web workbench | Ready for user review | [workbench design](../design/web-workbench.md); framework and visual style remain open |
| Candidate external Agent contract | Ready for user review | [transport-neutral capability contract](../integrations/agent-skill-contract.md); no Skill/API implementation exists |
| Real scoring or scenario engine | Not started | Candidate semantics exist; no runtime, fixture, or real-path evidence |
| Kimi material handling | Privately cleaned as authorized | Case remains dormant and unfinished; public repository retains only generalized semantics and non-identifying state/counts |
